    ...
    <!-- Start Shop Page  -->
        <div class="py-3 py-md-5 bg-light">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="mb-4" style="font-size: 25px">Our Categories:</h4>
                    </div>
                            ...
                            <div class="category-card">
                                <a href="{{ url('/collections/'.$categoryItem->name) }}">
                                    <div class="category-card-img">
                                        <img src="{{ asset('images/categoryImage.jpg') }}" class="" alt="Laptop">
                                    </div>
                                    <div class="card-body">
                                        <h5 style="font-size: 20px; ">{{ $categoryItem->name }}</h5>
                                    </div>
                                </a>
                            </div>
                        </div>
